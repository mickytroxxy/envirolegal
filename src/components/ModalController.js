            ...
            <View style={{flex:1,backgroundColor: 'rgba(0, 0, 0, 0.5)'}}>
                <View style={styles.centeredView}>
                    ...
                    <View style={{marginTop:5}}>
                        ...
                        {(props.modalState.attr.headerText === "SELECT BRAND" || props.modalState.attr.headerText === "SELECT GENDER" || props.modalState.attr.headerText === "SELECT CATEGORY") && <ModalSelector attr={attr}/>}
